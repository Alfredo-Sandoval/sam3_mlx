...
class Prompt:
    ...
    def _init_seq_len(self, box_embeddings, point_embeddings, mask_embeddings):
    ...
    def _init_box(
        self, box_embeddings, box_labels, box_mask, box_seq_len, bs, device=None
    ):
        del device
...
class MaskEncoder(nn.Module):
    ...
    def forward(self, masks, *args, **kwargs) -> Tuple[mx.array, mx.array]:
        del args, kwargs
    ...
    def __call__(self, masks, *args, **kwargs) -> Tuple[mx.array, mx.array]:
        return self.forward(masks, *args, **kwargs)
...
class FusedMaskEncoder(MaskEncoder):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        return self.forward(masks=masks, pix_feat=pix_feat, **kwargs)
...
class SequenceGeometryEncoder(nn.Module):
    ...
    def _encode_boxes(self, boxes, boxes_mask, boxes_labels, img_feats):
        ...
        if self.boxes_pool_project is not None:
            ...
            sampled = sampled.transpose(0, 2, 3, 1)
